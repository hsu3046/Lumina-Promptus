...
const LIGHTING_TOOL_OPTIONS = [
    { value: 'softbox', label: '소프트박스', desc: '부드러운 피부' },
    { value: 'beautydish', label: '뷰티 디쉬', desc: '선명한 윤곽' },
    { value: 'spotlight', label: '스포트라이트', desc: '집중 조명' },
    { value: 'umbrella', label: '엄브렐러', desc: '넓은 확산' },
] as const;

const BACKGROUND_DETAIL_OPTIONS = [
    { value: 'circular', label: '원형 캐치라이트', desc: '생기 있는 눈' },
    { value: 'window', label: '창문 캐치라이트', desc: '자연스러운 반사' },
    { value: 'halo', label: '광륜', desc: '배경 그라데이션' },
    { value: 'blackout', label: '배경 암전', desc: '인물만 부각' },
] as const;

const COLOR_TEMP_OPTIONS = [
    { value: '5600k', label: '표준 화이트', desc: '5600K 정확한 색상' },
    { value: '3200k', label: '따뜻한 텅스텐', desc: '3200K 온기' },
    { value: '7500k', label: '차가운 시네마틱', desc: '7500K 모던' },
