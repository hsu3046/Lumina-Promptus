...
// ===== NIKON F MOUNT (6종) =====
    {
        ...
        maxAperture: 'f/2.8',
        category: 'ultra_wide',
        bokeh: 'minimal background blur, deep focus look, low specular contrast',
        vignetting: 'moderate corner vignetting wide open, natural light falloff at edges',
        characteristic_studio: 'dynamic wide-angle fashion, exaggerated perspective, high-impact studio staging',
        characteristic_landscape: 'vast expansive vistas, dramatic leading lines, immense sky presence',
        characteristic_architecture: 'high geometric precision, architectural perspective correction, straight verticals (camera kept level), minimal barrel distortion',
        characteristic_product: 'extreme industrial perspective, creative close-up distortion, modern metallic rendering',
        characteristic_street: 'immersive urban atmosphere, ground-level dynamic view, wide environmental storytelling',
    ...
    },
    {
        ...
        characteristic_street: 'classic wide street photography, cinematic urban scenes, fast action in low light',
    ...
    },
    {
        ...
        maxAperture: 'f/1.4',
        category: 'standard',
        bokeh: 'soft rounded bokeh highlights, smooth background blur when close',
        vignetting: 'subtle natural vignetting wide open',
        characteristic_studio: 'medium-shot portrait, natural proportions, clean studio rendering',
        characteristic_landscape: 'intimate nature scenes, forest paths, natural mountain perspective',
        characteristic_architecture: 'classic street architecture, natural building proportions, clean edge-to-edge detail',
        characteristic_product: 'natural lifestyle product, everyday context, balanced focus transition',
        characteristic_street: 'documentary street portrait, natural storytelling, reportage standard',
    ...
    },
    {
        ...
        maxAperture: 'f/1.4',
        category: 'standard',
        bokeh: 'creamy soft bokeh, pleasing highlight circles, low harshness in specular bokeh',
        vignetting: 'subtle to moderate vignetting at f/1.4, improves when stopped down',
        characteristic_studio: 'noct-inspired studio portrait, gentle skin glow, artistic catchlights',
        characteristic_landscape: 'ethereal twilight landscape, soft rendering of distant lights, painterly horizon',
        characteristic_architecture: 'soft-edged urban night view, glowing point light sources, atmospheric city glow',
        characteristic_product: 'luminous product highlights, unique point light reproduction on glass/metal',
        characteristic_street: 'cinematic night street photography, smooth tonal rolloff, poetic low-light rendering',
    ...
    },
    {
        ...
        bokeh: 'smooth creamy bokeh, rounded specular highlights, soft blur transitions',
        vignetting: 'subtle vignette wide open, aesthetically pleasing for portraits',
        characteristic_studio: 'flattering studio portrait, perfect facial proportions, delicate skin micro-contrast',
        characteristic_landscape: 'compressed landscape layers, simplified mountain depth, elegant nature textures',
        characteristic_architecture: 'abstract architectural patterns, compressed building details, flat geometry',
        characteristic_product: 'premium item isolation, clean product edges, elegant focus falloff',
        characteristic_street: 'candid street portrait, discreet subject isolation, long-distance snapshot',
        apertureSpec: { min: 'f/1.4', max: 'f/16', stops: getApertureRange('f/1.4', 'f/16'), defaultValue: 'f/2.8' }
    },
    {
        ...
        maxAperture: 'f/1.4',
        category: 'medium_telephoto',
        bokeh: 'very smooth bokeh, dense background blur, silky blur gradients',
        vignetting: 'mild vignetting wide open, elegant edge shading',
        characteristic_studio: 'ultimate headshot isolation, 3D pop effect, professional skin rendering',
        characteristic_landscape: 'extreme landscape compression, ethereal mountain layering, distant focal points',
        characteristic_architecture: 'focused architectural detail, isolated structural elements, flat perspective',
        characteristic_product: 'extreme shallow-focus product art, buttery smooth item separation',
        characteristic_street: 'extreme background erasure, focused street character, telephoto bokeh art',
        apertureSpec: { min: 'f/1.4', max: 'f/16', stops: getApertureRange('f/1.4', 'f/16'), defaultValue: 'f/2.8' }
    },
